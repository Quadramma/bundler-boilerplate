	...
	<div id="content-wrapper">
		<div class="blocks-container">
                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="container">
									<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 vertical-align">
										<p class="slide-name">legal services</p>
										<p class="slide-title">MyLawyer</p>
										<p class="slide-text">Our law firm - a team of practitioners with years of successful experience in various areas of law in the service business and individuals. Our company is the provision of legal services poses a few simple goals: to put our best for your success, to respond to the request as soon as possible, to maintain confidentiality and to refer the matter very seriously.</p>
									</div>
                                </div>
                            </div>
							...
							<div class="block-header-wrapper">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-6 col-md-7 post animated fadeInRight">
										<div class="text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown pri.</div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-6 services">
									...
									<div class="description">
										...
										<div class="text">It regulates social conduct and prescribes whatever is threatening, harmful, or otherwise endangering to the property, health, safety, and moral...</div>
									</div>
								</div>
								<div class="col-xs-12 col-sm-6 services">
									...
									<div class="description">									
										...
										<div class="text">Personal injury is a legal term for an injury to the body, mind or emotions, as opposed to an injury to property. The most common types of personal injury...</div>
									</div>
								</div>								
							</div>
							<div class="row">
								<div class="col-xs-12 col-sm-6 services">
									...
									<div class="description">										
										<div class="title">Real Estate Law</div>
										<div class="text">Is the name given to the branch of civil law that covers rights to possess, use, and enjoy land and the permanent manmade additions attached to it...</div>
									</div>
								</div>
								<div class="col-xs-12 col-sm-6 services">
									...
									<div class="description">									
										...
										<div class="text">Family law consists of a body of statutes and case precedents that govern the legal responsibilities between individuals who share a domestic connection...</div>
									</div>
								</div>								
							</div>
			...
			<div class="block type-3">
				<img class="center-image" src="img/background-1.jpg" alt="" />
				<div class="container">
					<div class="row">
						<div class="block-header col-xs-12">
							<div class="block-header-wrapper">
			...
			<div class="block type-5">
				<img class="center-image" src="img/background-2.jpg" alt="" />
				<div class="container">
					<div class="row">
						<div class="block-header col-xs-12">
							<div class="block-header-wrapper">
                    ...
                    <div class="clients-wrapper post fadeInDown">
                        <div class="swiper-container" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="responsive" data-xs-slides="2" data-sm-slides="4" data-md-slides="4" data-lg-slides="6">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="clients-entry">
										<a href="#"><img class="img-responsive" src="img/logo-1.png" alt=""></a>
										<a href="#"><img class="img-responsive" src="img/logo-7.png" alt=""></a>										
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="clients-entry">
										<a href="#"><img class="img-responsive" src="img/logo-2.png" alt=""></a>
										<a href="#"><img class="img-responsive" src="img/logo-8.png" alt=""></a>										
                                    </div>
                                </div>
                                <div class="swiper-slide"> 
                                    <div class="clients-entry">
										<a href="#"><img class="img-responsive" src="img/logo-3.png" alt=""></a>
										<a href="#"><img class="img-responsive" src="img/logo-9.png" alt=""></a>										
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="clients-entry">
										<a href="#"><img class="img-responsive" src="img/logo-4.png" alt=""></a>
										<a href="#"><img class="img-responsive" src="img/logo-10.png" alt=""></a>									
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="clients-entry">
                                ...
                                <div class="swiper-slide">
                                    <div class="clients-entry">
										<a href="#"><img class="img-responsive" src="img/logo-5.png" alt=""></a>
										<a href="#"><img class="img-responsive" src="img/logo-11.png" alt=""></a>									
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="clients-entry">
										<a href="#"><img class="img-responsive" src="img/logo-6.png" alt=""></a>
										<a href="#"><img class="img-responsive" src="img/logo-12.png" alt=""></a>									
                                    </div>
                                </div>
								<div class="swiper-slide">
                                    <div class="clients-entry">
						...
						<div class="arrows">
							<div class="clients-arrow left"><img src="img/carusel-left.png" alt=""></div>
							<div class="clients-arrow right"><img src="img/carusel-right.png" alt=""></div>
						</div>							
                    </div>
                        ...
                        <div class="swiper-container" data-autoplay="0" data-loop="0" data-speed="500" data-slides-per-group="2" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="2">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
									<div class="row">
										<div class="col-xs-11 col-xs-offset-1 col-sm-10 col-sm-offset-2">
											<div class="testimonials-entry text-right">
												<img src="img/michael.png" alt="">
												<div class="content">
													<div class="name">Michael Shpak</div>
													<div class="job">Manager - <span>Mediafirm</span></div>
													<div class="text">Lorem Ipsum is simply dummy text of the printing and  indust  Lorem Ipsum has been the industry's standard dummy</div>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="swiper-slide">
									<div class="row">
										<div class="col-xs-11">									
											<div class="testimonials-entry text-left">
												<img src="img/antonio.png" alt="">
												<div class="content">
													<div class="name">Antonio Dumento</div>
													<div class="job">Director - <span>Callfirn</span></div>
				...
				<div class="container">
                    ...
                    <div class="row content-block post fadeInUp">
						<div class="col-xs-12 col-sm-6">
							...
							<div class="text">
								<p>Lorem Ipsum is simply All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin</p>
								<ul>
						...
						<div class="col-xs-12 col-sm-6">
							<h3 class="title">many variations of passages</h3>
							<div class="text">
								<p>Lorem Ipsum is simply All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
									...
									<div class="row">
										<div class="col-xs-10 col-xs-offset-1 col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-4">
											<div class="blog-post left">
												<img class="corner-rounding" src="img/blog-1.png" alt="">
												<div class="content">
													<div class="title">The standard chunk of Lorem Ipsum used since the 1500s</div>
													<div class="text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up</div>
									...
									<div class="row">
										<div class="col-xs-10 col-xs-offset-1 col-sm-9 col-sm-offset-0 col-md-8">									
											<div class="blog-post right">
												<img class="corner-rounding" src="img/blog-2.png" alt="">
												<div class="content">
													<div class="title">The standard chunk of Lorem Ipsum used since the 1500s</div>
													<div class="text">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up</div>
													<div class="meta-entry clearfix">
